...
- 真实深信服 MCP / XDR OpenAPI 尚未完成主链接入和独立复验。
...
|---|---|---|---|
| P0 | 真实平台 MCP / XDR OpenAPI 接入 | 是，影响生产闭环 | 补齐地址、鉴权、字段映射和集成测试 |
...
| P2 | `docs/modules/orchestration` 与 `docs/modules/主链` 边界整理 | 否 | 后续统一命名或建立索引 |
...
|---|---|---|---|
| 2026-08-26 | 当前工作区新增 | 新增主链开发说明，记录当前代码入口、配置、调用方式和边界 | `docs/modules/主链/test.md` |
