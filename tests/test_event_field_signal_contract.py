# -*- coding: utf-8 -*-
"""统一合同 v1.1 中“事件字段—来源—信号强度”的代码一致性测试。

负责人/执行人：陈敏（登记方）
日期：2026-09-13
唯一合同：docs/modules/investigation-agent/formal-event-context-and-knowledge-tool-contract-v1.md
字段登记附件：docs/modules/alert-correlation/event-field-signal-contract.md
